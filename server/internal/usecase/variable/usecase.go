...
func (u *Usecase) List(ctx context.Context, scope *commonModel.Scope) ([]*model.Main, error) {
...
func (u *Usecase) Set(ctx context.Context, scope commonModel.Scope, name, value string) error {
	if name == "" {
