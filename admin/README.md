...
даги (карточка: табы Обзор/Схема/Env/Настройки — раны и метрики, граф и
манифест, требования к окружению),
...
на месте (глобально или локально для дага). Незаполненные считаются по тому
